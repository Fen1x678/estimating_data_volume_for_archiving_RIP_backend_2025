...
class AlgorithmAddSerializer(serializers.ModelSerializer):
    class Meta:
        model = Algorithm
        fields = ("name", "description", "ratio", "image")


class CompressionBaseSerializer(serializers.ModelSerializer):
...
class CompressionsSerializer(CompressionBaseSerializer):
    algorithms_count = serializers.SerializerMethodField()

    def get_algorithms_count(self, compression):
        items = compression.algorithmcompression_set.all()
        return items.count()


class CompressionSerializer(CompressionBaseSerializer):
